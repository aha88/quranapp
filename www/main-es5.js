...
var map = {
	...
	"../../page/audio/audio.module": [
		"./src/app/page/audio/audio.module.ts",
		"common",
		"page-audio-audio-module"
	],
	"../../page/prayertime/prayertime.module": [
...
var routes = [
    ...
    // },
    { path: 'setting',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-setting-setting-module */ "page-setting-setting-module").then(__webpack_require__.bind(null, /*! ./page/setting/setting.module */ "./src/app/page/setting/setting.module.ts")).then(function (m) { return m.SettingPageModule; }); } },
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, geolocation, notification, alertCtrl, httpNoti, backgroundMode) {
        var _this = this;
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        var vaf = d.getDate();
        var arrayday = vaf - 1;
        this.httpNoti.get(this.myUrlNoti).subscribe(function (data) {
