...
const routes = [
    ...
    // },
    { path: 'setting',
        loadChildren: () => __webpack_require__.e(/*! import() | page-setting-setting-module */ "page-setting-setting-module").then(__webpack_require__.bind(null, /*! ./page/setting/setting.module */ "./src/app/page/setting/setting.module.ts")).then(m => m.SettingPageModule) },
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, geolocation, notification, alertCtrl, httpNoti, backgroundMode) {
