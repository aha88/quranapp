...
/***/ "./src/app/dataquran.service.ts":
/*!**************************************!*\
  !*** ./src/app/dataquran.service.ts ***!
  \**************************************/
/*! exports provided: DataquranService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataquranService", function() { return DataquranService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var DataquranService = /** @class */ (function () {
    function DataquranService(http) {
        this.http = http;
        this.langAPI = localStorage.getItem("language");
    }
    DataquranService.prototype.surahlisting = function () { return this.http.get('/assets/source/surah.json'); };
    DataquranService.prototype.audiolisting = function () { return this.http.get('/assets/source/reciter.json'); };
    DataquranService.prototype.surah = function (quranid) { return this.http.get('/assets/source/surah/surah_' + quranid + '.json'); };
    DataquranService.prototype.suraht = function (quranid) { return this.http.get('/assets/source/translation/' + this.langAPI + '/' + this.langAPI + '_translation_' + quranid + '.json'); };
    DataquranService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    DataquranService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], DataquranService);
    return DataquranService;
}());
