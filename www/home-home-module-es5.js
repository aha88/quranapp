...
var HomePage = /** @class */ (function () {
    function HomePage(quranlisting, navCtrl, loadingCtrl) {
    ...
    HomePage.prototype.ngOnInit = function () {
        var _this = this;
        this.quranlisting.surahlisting().subscribe(function (data) {
            _this.menulist = data['data']['allsurah'];
        });
    };
    ...
    HomePage.prototype.gotoquran = function (data) {
...
var FilterPipe = /** @class */ (function () {
    ...
    FilterPipe.prototype.transform = function (menulist, texto) {
        if (texto.length === 0) {
            return menulist;
        }
        texto == texto.toLocaleLowerCase();
        return menulist.filter(function (menulist) {
