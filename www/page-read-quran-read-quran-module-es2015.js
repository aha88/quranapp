...
let ReadQuranPageModule = class ReadQuranPageModule {
};
...
let ReadQuranPage = class ReadQuranPage {
    ...
    ngOnInit() {
        ...
        ;
        this.http.get('https://geoip-db.com/json/').subscribe((data) => {
        }, error => {
...
//# sourceMappingURL=page-read-quran-read-quran-module-es2015.js.map