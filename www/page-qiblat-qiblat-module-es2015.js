...
module.exports = "ion-content img {\n  position: absolute;\n  max-width: 250px;\n  max-height: 250px;\n  left: 0;\n  right: 0;\n  margin: 0 auto;\n  top: 30%;\n}\nion-content #div {\n  background: black;\n  height: 100%;\n  background-size: cover;\n}\nion-footer geo-coordinates {\n  color: black;\n  font-weight: 500;\n  font-size: 18px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let QiblatPage = class QiblatPage {
    constructor(deviceOrientation, platform) {
    ...
    deviceCompassInfo() {
        ...
        this.deviceSubscription = this.deviceOrientation.watchHeading().subscribe((data) => {
            this.rotateCompass(data.magneticHeading);
            this.compassDegree = Math.floor(data.magneticHeading);
            this.cardinalPosition = this.getCardinal(this.compassDegree);
        });
